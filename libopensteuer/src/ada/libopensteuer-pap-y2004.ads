package LibOpenSteuer.PAP.Y2004 is
   ...
   -- Rechenwert mit 6 Nachkommastellen:
   type RW_6 is delta 0.000001 digits System.Max_Base_Digits;
   ...
   -- (Feld SONSTB) oder bei Eingabe der "Vergütung für mehrjährige Tätigkeit"
   -- (Feld VMT).
...
private
   ...
   -- Entlastungsbetrag für Alleinerziehende in EUR.
   ...
   -- Sicherungsfeld von ZRE4VP in EUR, C bei der Berechnung des Vorwegabzugs
   -- für die Vergütung für mehrjährige Tätigkeit.
