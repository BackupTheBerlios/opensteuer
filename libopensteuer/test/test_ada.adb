...
---------------------------------------------------------------------
-- Simple program to demonstrate the use of libopensteuer with Ada --
---------------------------------------------------------------------
...
begin
   New_Line;
   Put_Line ("-----------------------------");
   Put_Line ("-- This is the Ada-program --");
   Put_Line ("-----------------------------");
   New_Line;
   Put_Line ("Lohnsteuer (german wage tax) (all amounts in Euro):");
   ...
   New_Line;
   Put_Line ("Einkommensteuer (german income tax) (all amounts in Euro):");
   for Year in Get_First_Year .. Get_Last_Year loop
      New_Line;
